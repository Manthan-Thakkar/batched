CREATE PROCEDURE [dbo].[spCreateUnassignedJobsData]
...
--		==================================[Do not change]================================================
	...
	IF @IsError = 0	
		...
		select 
				...
				-- TT.EstTotalHours,
				-- @autoUpdateRouteTimeEnabled  is true then use value from FeasibleRoutes table else TicketTask table
				CASE 
				...
				TT.taskClassification ,
				TT.MasterRollClassification,
