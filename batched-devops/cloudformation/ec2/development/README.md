...
**Step 1:** Edit the _parameters.json_ and file to match the new environment domain. Optionally, you can also edit _stack-name.json_ to change the name of the insatnce.
...
## Development
You can verify the cloudformation template while developing using the following command:
>sh validate.sh __\{REGION\}__