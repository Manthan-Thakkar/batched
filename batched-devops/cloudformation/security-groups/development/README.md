...
**Step 1:** Edit the _security-groups-params.json_ and file to match the new environment domain. Optionally, you can also edit _stack-name.json_ to change the name of the security groups.
